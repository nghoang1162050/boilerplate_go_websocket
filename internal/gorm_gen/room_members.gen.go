...
func newRoomMember(db *gorm.DB, opts ...gen.DOOption) roomMember {
	...
	_roomMember.RoomMembers = roomMemberHasManyRoomMembers{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("RoomMembers", "model.User"),
	}

	_roomMember.Room = roomMemberHasManyRoom{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("Room", "model.User"),
	}
...
type roomMember struct {
	...
	UserID      field.String
	JoinedAt    field.Time
	RoomMembers roomMemberHasManyRoomMembers

	Room roomMemberHasManyRoom
...
type roomMemberHasManyRoomMembers struct {
	db *gorm.DB

	field.RelationField
}

func (a roomMemberHasManyRoomMembers) Where(conds ...field.Expr) *roomMemberHasManyRoomMembers {
	if len(conds) == 0 {
		return &a
	}
...
func (a roomMemberHasManyRoomMembers) WithContext(ctx context.Context) *roomMemberHasManyRoomMembers {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a roomMemberHasManyRoomMembers) Session(session *gorm.Session) *roomMemberHasManyRoomMembers {
	a.db = a.db.Session(session)
	return &a
}

func (a roomMemberHasManyRoomMembers) Model(m *model.RoomMember) *roomMemberHasManyRoomMembersTx {
	return &roomMemberHasManyRoomMembersTx{a.db.Model(m).Association(a.Name())}
}

func (a roomMemberHasManyRoomMembers) Unscoped() *roomMemberHasManyRoomMembers {
	a.db = a.db.Unscoped()
	return &a
}

type roomMemberHasManyRoomMembersTx struct{ tx *gorm.Association }

func (a roomMemberHasManyRoomMembersTx) Find() (result []*model.User, err error) {
	return result, a.tx.Find(&result)
}

func (a roomMemberHasManyRoomMembersTx) Append(values ...*model.User) (err error) {
...
func (a roomMemberHasManyRoomMembersTx) Replace(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomMemberHasManyRoomMembersTx) Delete(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomMemberHasManyRoomMembersTx) Clear() error {
	return a.tx.Clear()
}

func (a roomMemberHasManyRoomMembersTx) Count() int64 {
	return a.tx.Count()
}

func (a roomMemberHasManyRoomMembersTx) Unscoped() *roomMemberHasManyRoomMembersTx {
	a.tx = a.tx.Unscoped()
	return &a
}

type roomMemberHasManyRoom struct {
	db *gorm.DB

	field.RelationField
}

func (a roomMemberHasManyRoom) Where(conds ...field.Expr) *roomMemberHasManyRoom {
	if len(conds) == 0 {
		return &a
	}
...
func (a roomMemberHasManyRoom) WithContext(ctx context.Context) *roomMemberHasManyRoom {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a roomMemberHasManyRoom) Session(session *gorm.Session) *roomMemberHasManyRoom {
	a.db = a.db.Session(session)
	return &a
}

func (a roomMemberHasManyRoom) Model(m *model.RoomMember) *roomMemberHasManyRoomTx {
	return &roomMemberHasManyRoomTx{a.db.Model(m).Association(a.Name())}
}

func (a roomMemberHasManyRoom) Unscoped() *roomMemberHasManyRoom {
	a.db = a.db.Unscoped()
	return &a
}

type roomMemberHasManyRoomTx struct{ tx *gorm.Association }

func (a roomMemberHasManyRoomTx) Find() (result []*model.User, err error) {
	return result, a.tx.Find(&result)
}

func (a roomMemberHasManyRoomTx) Append(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomMemberHasManyRoomTx) Replace(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomMemberHasManyRoomTx) Delete(values ...*model.User) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roomMemberHasManyRoomTx) Clear() error {
	return a.tx.Clear()
}

func (a roomMemberHasManyRoomTx) Count() int64 {
	return a.tx.Count()
}

func (a roomMemberHasManyRoomTx) Unscoped() *roomMemberHasManyRoomTx {
	a.tx = a.tx.Unscoped()
	return &a
}
